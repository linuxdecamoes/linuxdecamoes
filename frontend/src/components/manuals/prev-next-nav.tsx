    ...
    <nav className="grid grid-cols-2 gap-3" aria-label="Navegação entre tópicos">
      {prev ? (
        <Link
          ...
          className="group flex flex-col gap-1 border border-border bg-card p-4 transition-colors hover:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
      ...
      {next ? (
        <Link
          ...
          className="group flex flex-col gap-1 border border-border bg-card p-4 text-right transition-colors hover:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
