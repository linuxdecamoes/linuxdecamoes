...
export const manuals: Manual[] = [
  {
    ...
    topics: [
      { slug: "a-evolucao-do-linux-e-sistemas-operacionais-populares", title: "011.1 A evolucao do Linux e sistemas operacionais populares", objective: "011" },
      { slug: "principais-aplicacoes-open-source", title: "011.2 Principais Aplicacoes Open Source", objective: "011" },
      { slug: "entendendo-o-software-open-source-e-suas-licencas", title: "011.3 Entendendo o Software Open Source e suas Licensas", objective: "011" },
      { slug: "habilidades-ict-e-trabalhando-no-linux", title: "011.4 Habilidades ICT e trabalhando no Linux", objective: "011" },
      { slug: "o-basico-sobre-a-linha-de-comando", title: "012.1 O basico sobre a linha de comando", objective: "012" },
      { slug: "usando-a-linha-de-comando-para-conseguir-ajuda", title: "012.2 Usando a linha de comando para conseguir ajuda", objective: "012" },
      { slug: "usando-diretorios-e-listando-arquivos", title: "012.3 Usando diretorios e listando arquivos", objective: "012" },
      { slug: "criando-movendo-e-deletando-arquivos", title: "012.4 Criando, Movendo e Deletando Arquivos", objective: "012" },
      { slug: "empacotando-arquivos-na-linha-de-comando", title: "013.1 Empacotando arquivos na linha de comando", objective: "013" },
      { slug: "pesquisando-e-extraindo-dados-de-arquivos", title: "013.2 Pesquisando e extraindo dados de arquivos", objective: "013" },
      { slug: "transformando-comandos-em-scripts", title: "013.3 Transformando comandos em Scripts", objective: "013" },
      { slug: "escolhendo-um-sistema-operacional", title: "014.1 Escolhendo um Sistema Operacional", objective: "014" },
      { slug: "entendendo-o-hardware-do-computador", title: "014.2 Entendendo o Hardware do Computador", objective: "014" },
      { slug: "onde-os-dados-sao-armazenados", title: "014.3 Onde os dados sao armazenados", objective: "014" },
      { slug: "seu-computador-na-rede", title: "014.4 Seu Computador na Rede", objective: "014" },
      { slug: "seguranca-basica-e-identificacao-de-tipos-de-usuarios", title: "015.1 Seguranca Basica e Identificacao de Tipos de Usuarios", objective: "015" },
      { slug: "criando-usuarios-e-grupos", title: "015.2 Criando Usuarios e Grupos", objective: "015" },
      { slug: "gerenciando-permissoes-e-donos-de-arquivos", title: "015.3 Gerenciando permissoes e donos de arquivos", objective: "015" },
      { slug: "diretorios-e-arquivos-especiais", title: "015.4 Diretorios e arquivos especiais", objective: "015" },
    ],
  },
  {
    code: "020",
